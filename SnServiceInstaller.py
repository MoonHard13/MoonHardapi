...
class SnServiceInstaller:
    ...
    def uninstall(self):
        ...
        try:
            ...
            messagebox.showerror("Σφάλμα", f"Αποτυχία απεγκατάστασης SnService: {e}")
    ...
    def install(self):
        ...
        try:
            ...
            if not exe_path:
                ...
                messagebox.showerror("Σφάλμα", "Δεν βρέθηκε το αρχείο εγκατάστασης SnService.")
                return
            ...
            messagebox.showinfo("Επιτυχία", "Το SnService εγκαταστάθηκε επιτυχώς.")
        except subprocess.CalledProcessError as e:
            self.log(f"[Σφάλμα] Εγκατάστασης SnService: {e}")
            messagebox.showerror("Σφάλμα", f"SnService σφάλμα: {e}")
        except Exception as e:
            self.log(f"[Σφάλμα] Γενικό σφάλμα SnService: {e}")
            messagebox.showerror("Σφάλμα", f"Γενικό σφάλμα SnService: {e}")